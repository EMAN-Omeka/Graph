...
// Modified by Vincent BUARD 2017
(function(jQuery) {
    ...
    jQuery.fn.iconpicker = function(selector) {
        ...
        jQuery(this).focusin(function() {
            ...
            jQuery(".howl-iconpicker .geticonval").on('click', function() {
                ...
                if (jQuery(selector).attr('class') == whichInputClass) {
                  iconPUA = $('span#fa-' + getIconId).html();
                  jQuery("#" + whichInputId).siblings('p').html('<i class="fa fa-2x">&#x' + iconPUA + ';</i>');
                  jQuery("#" + whichInputId).val(iconPUA).change();
                }
            });
